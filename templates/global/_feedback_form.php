...
<form id="feedback-form" action="<?php echo url('action=feedback/send_feedback/post'); ?>" method="post">
  <h1><?php echo $feedback_form->title; ?></h1>
  <div id="feedback-info">
    <p>
      <?php echo $feedback_form->description; ?>
    </p>
  </div>
  ...
  Feedback.build_form = function(){
    ...
    $(this.options.feedback_form)
      ...
      .on('submit.feedback', function(e){
        ...
        $(Feedback.options.feedback_form).find('input[type=submit]').val('Sending...');
